...
public class DeleteTest
{
    ...
    public void test_emptyList_headNull()
    {
        ...
        // test node deletion
        assertNull("head no longer points to null", instance.getHead());
   ...
   // @Ignore
    ...
    public void test_nonEmptyList_invalidIndex_headNotNull()
    {
        ...
        boolean result = instance.delete(nodeIndex);
        // test node deletion
        assertEquals("head no longer pointing to first node of list", instance.getHead(), first);
    ...
    {    
        ...
        ListNode toDelete = instance.getHead();
        System.out.println("attempting to delete first node in list...");
        // select node to be deleted
        int nodeIndex = 1;
        boolean result = instance.delete(nodeIndex);
        // test node deletion    
        assertNotSame("head of list still connected to deleted node", instance.getHead(), toDelete);
    ...
    {    
        ...
        boolean result = instance.delete(nodeIndex);
        // test node deletion    
        assertNull("deleted node not connected to null", toDelete.getLink());
    ...
    public void test_nonEmptyList_deleteFirstNode_nodeStillConnected()
    {
        ...
        ListNode after = toDelete.getLink();
        System.out.println("attempting to delete first node in list...");
        // select node to be deleted
        int nodeIndex = 1;
        boolean result = instance.delete(nodeIndex);
        // test node deletion
        assertNotSame("node to be deleted still connected to list", toDelete.getLink(), after);
    ...
    public void test_nonEmptyList_deleteFirstNode_nodeBypassed()
    {
        ...
        boolean result = instance.delete(nodeIndex);
        // test node deletion
        assertEquals("deleted node not bypassed in list", instance.getHead(), after);
    ...
    {   
        ...
        // mark node to be deleted
        ListNode toDelete = before.getLink();
        System.out.println("attempting to delete a node in middle of list...");
        boolean result = instance.delete(nodeIndex);
        // test node deletion
        assertNotSame("first part of list still connected to node to be deleted", before.getLink(), toDelete);
    ...
    {   
        ...
        for (int i = 1; i < nodeIndex; i++)
            toDelete = toDelete.getLink();
        // mark node after node to be deleted
        ListNode after = toDelete.getLink();
        System.out.println("attempting to delete a node in middle of list...");
        boolean result = instance.delete(nodeIndex);
        // test node deletion
        assertNotSame("node to be deleted still connected to second half of list", toDelete.getLink(), after);
    ...
    {   
        ...
        boolean result = instance.delete(nodeIndex);
        // test node deletion
        assertNull("node to be deleted not connected to null", toDelete.getLink());
    ...
    {   
        ...
        boolean result = instance.delete(nodeIndex);
        // test node deletion
        assertEquals("deleted node not bypassed in list", before.getLink(), after);
    ...
    {   
        ...
        boolean result = instance.delete(nodeIndex);
        // test node deletion
        assertNull("new last node not connected to null", before.getLink());
    ...
    {   
        ...
        boolean result = instance.delete(nodeIndex);
        // test node deletion
        assertNull("deleted node not set to null", toDelete.getLink());
