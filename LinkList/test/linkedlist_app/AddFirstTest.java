...
public class AddFirstTest
{
    ...
    public void test_emptyList_newValueInsertedInNode()
    {
        ...
        instance.addFirst(obj);
        // test node insertion
        assertEquals("new data value not found in new node", instance.getHead().getData(), obj);
    ...
    public void test_nonEmptyList_newNodePointsNotToNull()
    {
        ...
        instance.addFirst(obj);
        // test node insertion
        assertNotNull("new node points to null", instance.getHead().getLink());
    ...
    public void test_nonEmptyList_newNodeConnectedToList()
    {
        ...
        instance.addFirst(obj);
        // test node insertion
        assertEquals("new node not connected to rest of list", instance.getHead().getLink(), current);
